      ...
      <ul id="header_employee_box" class="component">
        <li id="employee_infos" class="dropdown hidden-xs">
          ...
          <ul id="employee_links" class="dropdown-menu dropdown-menu-right">
            ...
            <li class="divider"></li>
            <li><a href="{l s='#'}" target="_blank"><i class="material-icons">book</i> {l s='Resources' d='Admin.Navigation.Header'}</a></li>
            <li><a href="{l s='#' d='Admin.Navigation.Header'}" target="_blank"><i class="material-icons">school</i> {l s='Training' d='Admin.Navigation.Header'}</a></li>
            <li><a href="{l s='#' d='Admin.Navigation.Header'}" target="_blank"><i class="material-icons">person_pin_circle</i> {l s='Find an Expert' d='Admin.Navigation.Header'}</a></li>
            <li><a href="{l s='#' d='Admin.Navigation.Header'}" target="_blank"><i class="material-icons">extension</i> {l s='Marketplace' d='Admin.Navigation.Header'}</a></li>
            <li><a href="{l s='#' d='Admin.Navigation.Header'}" target="_blank"><i class="material-icons">help</i> {l s='Help Center' d='Admin.Global'}</a></li>
            {if $host_mode}
              <li><a href="#" class="_blank"><i class="material-icons">settings_applications</i> {l s='My account' d='Admin.Navigation.Header'}</a></li>
            {/if}
            <li class="divider"></li>
