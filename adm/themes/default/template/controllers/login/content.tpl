...
<div id="login-panel">
	<div id="login-header">
		<h1 class="text-center">
			{*<img id="logo" src="#" width="123px" height="24px" alt="Treina Store" />*}
		</h1>
	...
	{*<div id="shop-img"><img src="#" alt="{$shop_name}" width="69.5px" height="118.5px" /></div>*}
	...
	<div id="login-footer">
		<p class="text-center text-muted">
			<a href="#" onclick="return !window.open(this.href);">
				&copy; Treina Store&#8482; 2020-{$smarty.now|date_format:"%Y"} - All rights reserved
			</a>
		</p>
		<p class="text-center">
